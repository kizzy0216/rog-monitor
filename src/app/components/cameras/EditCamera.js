          ...
          <FormItem label="Camera Time Zone">
            {getFieldDecorator('time_zone', {
              ...
              <Select
                ...
                <Option value="NST">New Zealand Standard Time (UTC+12:00)</Option>
                <Option value="MIT">Midway Islands Time (UTC-11:00)</Option>
                <Option value="HST">Hawaii Standard Time (UTC-10:00)</Option>
                <Option value="AST">Alaska Standard Time (UTC-9:00)</Option>
...
class EditCamera extends Component {
  ...
  handleCreate = (e) => {
    ...
    form.validateFields((err, values) => {
      ...
      values.rtsp_url = str.trim(this.props.data.rtspUrl);
