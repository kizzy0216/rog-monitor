...
export const BVC_INTERACTION_IN_PROCESS = 'BVC_INTERACTION_IN_PROCESS';
export const BVC_AUTH_SUCCESS = 'BVC_AUTH_SUCCESS';
export const BVC_AUTH_ERROR = 'BVC_AUTH_ERROR';
